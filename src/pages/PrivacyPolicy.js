    ...
    <>
      ...
      <div className='info-white-bg shadow'>
        <div className='info-content'>
          ...
          <h4>Introduction</h4>
          <p>
            Love is in Cyprus is committed to protecting your privacy. We aim to
            ...
            to a minimum. This Cookie Policy explains what cookies are, what
            types of cookies are placed on your device when you visit our
            website and how we use them. This Cookie Policy does not address how
            we deal with your personal information generally.
          </p>
          <br />
          ...
          <p>
            ...
            beacons. For simplicity, we also refer to these technologies as
            “cookies” in this Cookie Policy.
          </p>
          <br />
          ...
          <p>
            ...
            for advertisers, selecting advertisements that are based on your
            interests and measuring the number of ads displayed and their
            performance, such as how many people clicked on a given ad.
          </p>
          <br />
          ...
          <br />
          <h4>Tools within this Cookie Policy</h4>
          <p>
            You can set and modify your cookie preferences at any time, by using
            the Cookie Management Preference Tool available at the top of this
            Cookies Policy.
          </p>
          <br />
          ...
          <p>
            ...
            particular browser help menu. You also may be able to reset device
            identifiers by activating the appropriate setting on your mobile
            device. The procedure for managing device identifiers is slightly
            different for each device. You can check the specific steps in the
            help or settings menu of your particular device.
          </p>
          <br />
          <h4>Interest-based advertising tools</h4>
          <p>
            ...
            only). Opting out does not mean you will not see advertising - it
            means you won't see personalized advertising from the companies that
          ...
          <p>
            ...
            website use social media plugins (e.g., Twitter™ “Share to Twitter”
            ...
            platform when you use the corresponding button on our website. To
            learn more about social media cookies, we suggest you refer to your
          ...
          <p>
            ...
            interface separate from that supplied by your browser. If your
            terminal is likely to display content developed using the Flash
            platform, we suggest you access your Flash cookie management tools
            directly via{' '}
            <Link
              to={{
                pathname: 'https://www.adobe.com',
              }}
              target='_blank'
            >
              www.adobe.com
          ...
          <br />
          <h4>Google™ Maps API Cookies</h4>
          <p>
            Some features of our website and some Love is in Cyprus services may
            rely on the use of Google™ Maps API Cookies. Such cookies will be
            stored on your device. When browsing this website and using the
            services relying on Google™ Maps API cookies, you consent to the
            storage, collection of such cookies on your device and to the
            access, usage and sharing by Google of the data collected thereby.
          ...
          <p>
            ...
            trends. You can opt out of Google Analytics by visiting{' '}
            <Link
              to={{
                pathname: 'https://www.google.com/settings/ads/',
              }}
              target='_blank'
            >
          ...
          <p>
            Online: <Link to='/contact-us'>here</Link>
          </p>
          <br />
          <p>By post:</p>
          ...
          <br />
          <h2>Analytics</h2>
          <h4>Who we share your data with, and how long we retain your data</h4>
          <p>
          ...
          <div className='bullets'>
            <ul>
              <li>
                We are compliant with General Data Protection Regulations and
                the Data Protection Act
              </li>
              <li>
                Our payment gateway meets the Payment Card Industry Data
                Security Standard
              </li>
              <li>
                We employ specialist software to vigorously monitor all
                attempted access to the site to ensure that no unauthorised
                access is made
              </li>
            </ul>
          </div>
          ...
          <p>
            Selected third-parties may advertise their goods and services on
            this site
          </p>
        </div>
      </div>
